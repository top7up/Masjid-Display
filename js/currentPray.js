...
function countDown(time, element) {
  var x = setInterval(function() {
	...
	var seconds = pad(Math.floor(((distance + 9000) % (1000 * 60)) / 1000),2);
...
function run() {
  ...
  console.log(document.getElementById(currentPrayObject.name));
  document.getElementById(currentPrayObject.name).id = "NextPrayer";
